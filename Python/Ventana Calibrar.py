...
#Paneles
    ...
    ButtonIniciar=tk.Button(Panel_Flechas, text="Iniciar",  state = 'normal' , width = "5" , height= "2", background ="green" , command = VentanaLogin.abrirVentanaLogin).place(x=250, y=330)
